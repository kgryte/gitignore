...
describe( 'async', function tests() {
	...
	it( 'should create a .gitignore file in a specified directory', function test( done ) {
		var dirpath;
	...
	it( 'should create a .gitignore file in a specified directory without requiring a callback', function test( done ) {
		var dirpath;
	...
	it( 'should create a .gitignore file using a specified template', function test( done ) {
		var dirpath;
